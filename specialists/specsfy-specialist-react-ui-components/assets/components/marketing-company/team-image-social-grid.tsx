...
function SocialLinks({ person }) {
  return (
    <ul role="list" className="mt-6 flex gap-x-6">
      <li>
        <a href={person.xUrl} className="text-gray-400 hover:text-gray-500 dark:hover:text-gray-300">
      ...
      <li>
        <a href={person.linkedinUrl} className="text-gray-400 hover:text-gray-500 dark:hover:text-gray-300">
