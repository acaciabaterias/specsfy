...
| `docs/` | documentação oficial e contexto transversal |
...
- O documentador local publica em `docs/`.
- A release local altera artefatos em `cli/` e publica tag e release no
  monorepo.
- `example/README.md` documenta o aplicativo; `docs/` orienta usuários do método.
