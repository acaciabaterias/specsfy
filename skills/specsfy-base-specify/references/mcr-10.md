...
3. **Lacuna:** o ponto que impede avançar.
...
categorias:
  ...
  - posse
status: declarado
fonte: "Entrevista com o responsável pelo produto"
dependencias:
...
- inferências materiais foram confirmadas ou permanecem abertas;
- não existe questão P1 sem resposta;
