...
Documentação técnica reconstruída a partir do código de **laravel/react-starter-kit**.
Serve como mapa de entrada para humanos e agentes; fontes executáveis continuam
prevalecendo quando houver divergência.

- Stack observada: Laravel, Pest, React, Tailwind CSS
- Arquivos de código mapeados: 249
- Testes mapeados: 30
- Entidades persistentes mapeadas: 12
- Pacotes mapeados: 68
