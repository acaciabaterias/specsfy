# Validar a definição com `specsfy-base-validate`
...
Use antes de planejar tarefas ou quando uma mudança reabrir o Ato I. Também é
...
Uma falha de parser, fixture ou ambiente não conta como prova de requisito
ausente.
...
[`specsfy-base-tasks`](specsfy-base-tasks.md). Se a validação encontrar uma
decisão aberta, use [`specsfy-base-interview`](specsfy-base-interview.md).
