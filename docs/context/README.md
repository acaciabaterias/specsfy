...
O [`AGENTS.md` do workspace](https://github.com/promovaweb/specsfy/blob/main/AGENTS.md)
...
| Documentação técnica gerada no consumidor | [documentação técnica do sistema](../system-documentation.md) | a topologia ou o ciclo de reconstrução mudar |
...
| Motivação e alternativas históricas | ADR em `docs/decisions/` |
