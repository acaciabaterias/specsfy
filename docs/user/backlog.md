...
2. A mesma skill apresenta uma pergunta numerada por rodada e
...
O agente identifica lacunas e pergunta uma por rodada. Definições que alteram
segurança, escopo, arquitetura ou
