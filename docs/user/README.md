...
Este mesmo percurso compõe a edição portátil **v1.7.1**. Use o PDF para leitura
e impressão ou o EPUB em leitores que permitem ajustar fonte e tamanho:

- [PDF](../../ebook/Specsfy-Guia-do-Usuario-v1.7.1.pdf), para leitura,
  compartilhamento e impressão.
- [EPUB](../../ebook/Specsfy-Guia-do-Usuario-v1.7.1.epub), para leitores
