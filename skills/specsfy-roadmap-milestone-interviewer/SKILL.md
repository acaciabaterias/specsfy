...
1. Reafirme o limite atual do MVP e pergunte qual aprendizado, necessidade de
   operação ou oportunidade justifica a próxima etapa.
2. Reflita cada resposta em uma síntese curta e formule a próxima pergunta pela
   lacuna que ainda impede identificar um estado demonstrável posterior.
